...
class Conversation(models.Model):
    ...
    partner_ids = fields.Many2many(
        string="Participantes", comodel_name="res.partner", default=_default_participants
    )
    last_message_post = fields.Datetime(string="Ultimo mensaje")
    last_message_by = fields.Many2one(
        string="Ultimo mensaje", comodel_name="res.partner", ondelete="set null"
    )
    is_participant = fields.Boolean(
        string="Yo participo", compute="_compute_is_participant"
    )
    ...
    message_needaction_count = fields.Integer(
        string="Mensajes", compute="_compute_message_count"
    )
