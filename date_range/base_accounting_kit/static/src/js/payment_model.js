...
var StatementModel = BasicModel.extend({
    ...
    quickCreateProposition: function (handle, reconcileModelId) {
        ...
        var fields = ['display_name', 'account_id', 'amount', 'amount_type', 'analytic_account_id', 'journal_id', 'label', 'force_tax_included', 'tax_ids', 'analytic_tag_ids', 'to_check', 'amount_from_label_regex', 'decimal_separator'];
