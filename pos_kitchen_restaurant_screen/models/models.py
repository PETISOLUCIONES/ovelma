...
class PosKitchenOrder(models.Model):
	...
	floor_id = fields.Many2one("restaurant.floor",string="Piso")
	table_id = fields.Many2one("restaurant.table",string="Mesa No")
	# @api.model
...
class PosConfig(models.Model):
	...
	order_action = fields.Selection([('validation','En Validación de Pedido'),('order_button','Haciendo clic en el botón Enviar Orden')],default="order_button")
