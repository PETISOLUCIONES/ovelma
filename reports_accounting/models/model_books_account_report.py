...
class libro_diario_report(models.TransientModel):
    ...
    def get_pdf(self):        
        ...
        action = {
                    ...
                    'url': "web/content/?model=libro_diario.report&id=" + str(self.id) + "&filename_field=pdf_file_name&field=pdf_file&download=true&filename=" + self.pdf_file_name,
                    'target': 'self',
                }
        return action
...
class libro_mayor_report(models.TransientModel):
    ...
    def get_pdf(self):        
        ...
        action = {
                    ...
                    'type': 'ir.actions.act_url',
                    'url': "web/content/?model=libro_mayor.report&id=" + str(self.id) + "&filename_field=pdf_file_name&field=pdf_file&download=true&filename=" + self.pdf_file_name,
                    'target': 'self',
                }
        return action
